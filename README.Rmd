...
y_train <- read.csv(file.path(dataset_dir, "train\\y_train.txt"), header = F, sep="")
y_test <- read.csv(file.path(dataset_dir, "test\\y_test.txt"), header = F, sep="")

x_train <- read.csv(file.path(dataset_dir, "train\\X_train.txt"), header = F, sep="")
x_test <- read.csv(file.path(dataset_dir, "test\\X_test.txt"), header = F, sep="")

subject_train <- read.csv(file.path(dataset_dir, "train\\subject_train.txt"), header = F, sep="")
subject_test <- read.csv(file.path(dataset_dir, "test\\subject_test.txt"), header = F, sep="")

features <- read.csv(file.path(dataset_dir, "features.txt"), header = F, sep="")
activity_labels <- read.csv(file.path(dataset_dir, "activity_labels.txt"), header = F, sep="")
